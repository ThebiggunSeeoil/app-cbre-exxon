...
# ALLOWED_HOSTS = ['https://cbre-exxon-appss.herokuapp.com', '5e00eb5d27dc.ngrok.io','127.0.0.1', config('SERVER', default='127.0.0.1')]
ALLOWED_HOSTS = ['cbre-exxon-appss.herokuapp.com']
